...
<main>
    <section class="container">
        ...
        <div class="photos">
            ...
            <a href="membres.php?id=6"><img class="photo_gb" src="public/images/Guillaume.png" alt="Photo profil Guillaume"></a>
            <a href="membres.php?id=7"><img class="photo_gb" src="public/images/Lou.png" alt="Photo profil Lou"></a>
            <a href="membres.php?id=8"><img class="photo_gb" src="public/images/Maïna.png" alt="Photo profil Maïna"></a>
            <a href="membres.php?id=9"><img class="photo_gb" src="public/images/Ruben.png" alt="Photo profil Ruben"></a>
        </div>
>>>>>>> Stashed changes
