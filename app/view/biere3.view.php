...
<div class="beer-description">
  <h2>LAVANDE COSMIQUE</h2>
  <p>Une bière qui vous fera voyager à travers un mélange d'agrumes et épices, avec des arômes de lavande.</p>
  <p>Bière brune à la lavande d’inspiration belge non ﬁltrée non pasteurisée.</p>
  <h3>Ingrédients:</h3>
  <ul>
    <li>Eau: 92,04%</li>
    <li>Malts</li>
...
<img src="smartmockups_lt8umi7b.png" alt="Beer Portrait" class="portrait-image">
</main>
<footer>
