...
<div class="beer-description">
  ...
  <p>Bière blanche au pavot bleu d’inspiration belge non ﬁltrée non pasteurisée.</p>
  <h3>Ingrédients:</h3>
  <ul>
    <li>Eau: 92,04%</li>
    <li>Malts</li>
    <li>Houblon: 0,17%</li>
    <li>Levure: 0,04%</li>
    <li>Fleur de pavot bleu: 0,03%</li>
...
<img src="smartmockups_lt8uj8w8.png" alt="Beer Portrait" class="portrait-image">
</main>
<footer>
