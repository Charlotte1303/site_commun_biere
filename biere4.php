...
<div class="beer-description">
  <h2>MENTHE CÉLESTE</h2>
  <p>Une bière qui vous fera voyager à travers un mélange d'agrumes et épices, avec des arômes de menthe.</p>
  <p>Bière ambrée mentholée d’inspiration belge non ﬁltrée non pasteurisée.</p>
  <h3>Ingrédients:</h3>
  <ul>
    <li>Eau: 92,04%</li>
    <li>Malts</li>
...
<img src="smartmockups_lt8uo3ut.png" alt="Beer Portrait" class="portrait-image">
</main>
<footer>
