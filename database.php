...
$trombi = [
    ...
    8 => [
        ...
        'age' => '19',
        'descriptif' => "Salut,
        Je m'appelle Maïna. Je passe mon temps à rigoler, je suis un vrai clown. Je suis curieuse et toujours motivée pour apprendre de nouvelles choses 😊. Me lancer dans ce projet m'a permis de découvrir l'univers de la bière, qui est un domaine beaucoup plus riche que ce que l'on pense. Je vous laisse découvrir tout ça grâce à notre marque Infinité ✨.",
    ],
    9 => [
        'id' => 9,
